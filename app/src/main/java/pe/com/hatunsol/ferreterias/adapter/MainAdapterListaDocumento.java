 ...
 */
public class MainAdapterListaDocumento extends ArrayAdapter<Documento> implements OpcDocumentosDialogfragment.OpcDocumentosDialogfragmentListener {
    private Context myContext;
    ProgressDialog mProgressDialog;
    private ProgressDialogFragment mProgressDialogFragment;

    public MainAdapterListaDocumento(Context context, int resource, List<Documento> objects) {
    ...
    public class EliminarDocumentos extends AsyncTask<Void, Void, RestResult> {
        ...
        protected void onPostExecute(RestResult restResult) {
            ...
            try {
                ((DocumentosActivity) context).onRefresh();
        ...
        protected RestResult doInBackground(Void... params) {
            ...
            return new RestClient().get("DocumentoAdjunto.svc/Eliminar?AdjuntoId=" + AdjuntoId, stringEntity, 30000);
    ...
    public class Click_Grilla implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            opcionesDialogfragment.setmOpcDocumentosDialogfragmentfragmentListener(MainAdapterListaDocumento.this);
