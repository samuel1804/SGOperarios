...
import pe.com.hatunsol.ferreterias.adapter.MainAdapterListaSupervisor;
 ...
 */
public class BuscarSupervisorActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener, AceptarDialogfragment.AceptarDialogfragmentListener {
    private List<Supervisor> lsListadoSupervisor = null;
    private MainAdapterListaSupervisor mMainAdapterListaSupervisor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buscar_supervisor);
        lvSupervisores = (ListView) findViewById(R.id.lvSupervisores);
    ...
    View.OnClickListener fabOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            /*Intent intent = new Intent(BuscarSupervisorActivity.this, EstablecimientoActivity.class);
    ...
    private void llenarListaProveedorLocal() {
        ...
        mMainAdapterListaSupervisor = new MainAdapterListaSupervisor(BuscarSupervisorActivity.this, 0, lsListadoSupervisor);
        lvSupervisores.setAdapter(mMainAdapterListaSupervisor);
        mMainAdapterListaSupervisor.notifyDataSetChanged();
            ...
            try {
                ...
                if (filePath != null) {
                    ...
                    if (bitmap == null) {
                        ...
                        dialog = ProgressDialog.show(BuscarSupervisorActivity.this, "Subiendo",
    ...
    public class ImageGalleryTask extends AsyncTask<Void, Void, RestResult> {
        ...
        protected void onPostExecute(RestResult restResult) {
            ...
            confirmacionDialogfragment.setmConfirmacionDialogfragmentListener(BuscarSupervisorActivity.this);
        ...
        protected RestResult doInBackground(Void... params) {
            ...
            try {
                ...
                jsonObject.put("IdSupervisor", IdSupervisor);
            ...
            return new RestClient().post("Supervisor.svc/UploadPhoto", stringEntity, 120000);
    ...
    class BuscarProveedorAsyncTask extends AsyncTask<Void, Void, RestResult> {
        ...
        protected void onPostExecute(RestResult restResult) {
            ...
            try {
                if (restResult.getResult() == "") {
                    Toast.makeText(BuscarSupervisorActivity.this, "No se encontraron Supervisores", Toast.LENGTH_SHORT).show();
                    mSwipeRefreshLayout.setRefreshing(false);
                    return;
                }
                ...
                lsListadoSupervisor = new ArrayList<>();
                Supervisor supervisor;
                for (int i = 0; i < jsonarray.length(); i++) {
                    JSONObject jsonobj = jsonarray.getJSONObject(i);
                    supervisor = new Supervisor();
                    supervisor.setIdSupervisor(jsonobj.getInt("IdSupervisor"));
                    supervisor.setNombre(jsonobj.getString("Nombre"));
                    supervisor.setLocalNombre(jsonobj.getString("LocalNombre"));
                    supervisor.setTelefono(jsonobj.getString("Celular"));
                    supervisor.setFoto(jsonobj.getString("Foto"));
                  /*  if (!jsonobj.getString("Foto")==null) {
                    ...
                    lsListadoSupervisor.add((supervisor));
                }
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(BuscarSupervisorActivity.this, "Cargando Supervisores", Toast.LENGTH_SHORT).show();
        }
...
return null;
           // return new RestClient().get("Supervisor.svc/Supervisor?LocalId=0&Nombre=" + etBuscar.getText().toString() + "&ZonaId=" + Util.BE_DatosUsuario.getZonaId(), stringEntity, 30000);
        }
    }
