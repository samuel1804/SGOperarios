 ...
 */
public class BuscarObraActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener, AceptarDialogfragment.AceptarDialogfragmentListener {
    ...
    private void llenarListaProveedorLocal() {
        ...
        mMainAdapterListaEstablecimiento = new MainAdapterListaObra(BuscarObraActivity.this, 0, lsListadoProveedorLocal);
            ...
            try {
                ...
                if (filePath != null) {
                    ...
                    if (bitmap == null) {
                        ...
                        dialog = ProgressDialog.show(BuscarObraActivity.this, "Subiendo",
    ...
    public class ImageGalleryTask extends AsyncTask<Void, Void, RestResult> {
        ...
        protected void onPostExecute(RestResult restResult) {
            ...
            confirmacionDialogfragment.setmConfirmacionDialogfragmentListener(BuscarObraActivity.this);
    ...
    class BuscarProveedorAsyncTask extends AsyncTask<Void, Void, RestResult> {
        ...
        protected void onPostExecute(RestResult restResult) {
            ...
            try {
                if (restResult.getResult() == "") {
                    Toast.makeText(BuscarObraActivity.this, "No se encontraron Establecimientos", Toast.LENGTH_SHORT).show();
                    mSwipeRefreshLayout.setRefreshing(false);
                    return;
                }
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(BuscarObraActivity.this, "Cargando Obras", Toast.LENGTH_SHORT).show();
        }
