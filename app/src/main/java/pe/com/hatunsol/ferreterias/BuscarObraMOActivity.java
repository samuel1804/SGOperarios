...
import pe.com.hatunsol.ferreterias.adapter.MainAdapterListaObra;
 ...
 */
public class BuscarObraMOActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener, AceptarDialogfragment.AceptarDialogfragmentListener {
    private List<Obra> lsListadoProveedorLocal = null;
    private MainAdapterListaObra mMainAdapterListaEstablecimiento;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buscar_obra);
        ...
        if (lsListadoProveedorLocal == null) {
            onRefresh();
        } else {
    ...
    View.OnClickListener fabOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
         /*   Intent intent = new Intent(BuscarObraActivity.this, EstablecimientoActivity.class);
    ...
    private void llenarListaProveedorLocal() {
        ...
        mMainAdapterListaEstablecimiento = new MainAdapterListaObra(BuscarObraMOActivity.this, 0, lsListadoProveedorLocal);
            ...
            try {
                ...
                if (filePath != null) {
                    ...
                    if (bitmap == null) {
                        ...
                        dialog = ProgressDialog.show(BuscarObraMOActivity.this, "Subiendo",
    ...
    public class ImageGalleryTask extends AsyncTask<Void, Void, RestResult> {
        ...
        protected void onPostExecute(RestResult restResult) {
            ...
            confirmacionDialogfragment.setmConfirmacionDialogfragmentListener(BuscarObraMOActivity.this);
    ...
    class BuscarProveedorAsyncTask extends AsyncTask<Void, Void, RestResult> {
        ...
        protected void onPostExecute(RestResult restResult) {
            ...
            try {
                if (restResult.getResult() == "") {
                    Toast.makeText(BuscarObraMOActivity.this, "No se encontraron Establecimientos", Toast.LENGTH_SHORT).show();
                    mSwipeRefreshLayout.setRefreshing(false);
                    return;
                }
                ...
                lsListadoProveedorLocal = new ArrayList<>();
                Obra proveedorlocal;
                for (int i = 0; i < jsonarray.length(); i++){
                    JSONObject jsonobj = jsonarray.getJSONObject(i);
                    proveedorlocal = new Obra();
                    proveedorlocal.setIdObra(jsonobj.getInt("IdObra"));
                    proveedorlocal.setNombre(jsonobj.getString("Nombre"));
                    proveedorlocal.setUnidadMedidaNombre(jsonobj.getString("UnidadMedidaNombre"));
                    proveedorlocal.setFoto(jsonobj.getString("Foto"));
                    proveedorlocal.setDescripcion(jsonobj.getString("Descripcion"));
                    proveedorlocal.setUnidadMedidaCorto(jsonobj.getString("UnidadMedidaCorto"));

                   /* if (!jsonobj.getString("Foto").equals("")) {
                        //proveedorlocal.setFoto(jsonobj.getString("Foto"));
                    }*/

                    lsListadoProveedorLocal.add((proveedorlocal));
                }
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(BuscarObraMOActivity.this, "Cargando Obras", Toast.LENGTH_SHORT).show();
        }
        ...
        protected RestResult doInBackground(Void... params) {
            ...
            return new RestClient().get("ObraWS.svc/Obra?Descripcion=" + etBuscar.getText().toString() , stringEntity, 30000);
        }
    }
