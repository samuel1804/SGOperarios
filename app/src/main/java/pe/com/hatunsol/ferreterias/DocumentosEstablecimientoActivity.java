 ...
 */
public class DocumentosEstablecimientoActivity extends Fragment implements SwipeRefreshLayout.OnRefreshListener, DocumentosEstablecDialogFragment.DocumentosDialogfragmentListener, AceptarDialogfragment.AceptarDialogfragmentListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_documentosestablecimiento, container, false);
        return v;
    }
...
*/
    ...
    View.OnClickListener tvAgregarDocumentoOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
           ...
           /* Bundle bundle = new Bundle();
            ...
            documentosDialogFragment.setmDocumentosDialogfragmentListener(DocumentosEstablecimientoActivity.this);
    ...
    class ListarDocumentosAsyncTask extends AsyncTask<Void, Void, RestResult> {
        ...
        protected RestResult doInBackground(Void... params) {
            ...
            Bundle extras = getActivity().getIntent().getExtras();
            String str = "" + extras.getInt("ProveedorId");

                return new RestClient().get("DocumentoAdjuntoProveedor.svc/Documento?ProveedorId=".concat(str), stringEntity, 30000);
    ...
    public class ImageGalleryTask extends AsyncTask<Void, Void, RestResult> {
        ...
        protected void onPostExecute(RestResult restResult) {
            ...
            confirmacionDialogfragment.setmConfirmacionDialogfragmentListener(DocumentosEstablecimientoActivity.this);
